      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Each role includes the full story behind the bullet points.
          </p>
        </div>

        {/* Experience cards */}
        <div className="space-y-6">
          {tevProfile.experience.map((exp, index) => (
            <ExperienceCard
              key={exp.company}
              {...exp}
              index={index}
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6">
          <div className="p-6 bg-success-muted border border-success/20 rounded-2xl">
            ...
            <ul className="space-y-2">
              {tevProfile.skills.strong.map((skill) => (
          ...
          <div className="p-6 bg-secondary border border-border rounded-2xl">
            ...
            <ul className="space-y-2">
              {tevProfile.skills.moderate.map((skill) => (
                <li key={skill} className="text-foreground flex items-center gap-2">
          ...
          <div className="p-6 bg-warning-muted border border-warning/20 rounded-2xl">
            ...
            <ul className="space-y-2">
              {tevProfile.skills.gaps.map((skill) => (
                <li key={skill} className="text-foreground flex items-center gap-2">
