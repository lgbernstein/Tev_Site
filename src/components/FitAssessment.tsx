...
import { fitAssessments } from "@/data/tev-profile";

type FitType = "strong" | "weak";

const jobDescriptions = {
  strong: `Audio Electronics Intern — Boutique Pedal & Synth Manufacturer

We're looking for someone who understands both music and electronics. You'll assist with building, testing, and repairing analog audio circuits. Soldering skills required. Familiarity with signal processing and audio gear is a strong plus...`,
  weak: `Senior Hardware Engineer — Consumer Electronics

We need an experienced EE with 5+ years designing production PCBs, embedded firmware development, and manufacturing scale experience. You'll own our hardware platform from prototype through mass production...`,
};
